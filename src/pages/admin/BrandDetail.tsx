...
export default function BrandDetail() {
  ...
  if (loading) return <div style={{ textAlign: 'center', padding: '80px', color: '#777683', fontFamily: 'var(--font-display)' }}>Memuat...</div>;
    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: '24px' }} className="detail-grid">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div style={cardStyle}>
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '24px', flexWrap: 'wrap', gap: '12px' }}>
              <div>
                ...
                <h2 style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: '1.4rem', color: '#191c20', marginBottom: '4px' }}>
                  {brand.namaBrand}
                </h2>
          ...
          {/* Campaign details */}
          <div style={cardStyle}>
            <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: '1rem', color: '#191c20', marginBottom: '20px' }}>
              Detail Campaign
            </h3>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div style={cardStyle}>
            ...
            <div style={{ marginBottom: '16px' }}>
              <label style={{ display: 'block', fontFamily: 'var(--font-display)', fontWeight: 600, fontSize: '0.8rem', color: '#191c20', marginBottom: '6px' }}>
                Status
              </label>
              <select
                value={status}
