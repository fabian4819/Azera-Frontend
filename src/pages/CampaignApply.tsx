  ...
  if (notFound) {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f8f9ff', padding: '24px' }}>
        <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", color: '#464652' }}>Campaign tidak ditemukan atau pendaftaran sudah ditutup.</p>
      </div>
    );
  }
      ...
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f8f9ff', padding: '24px', paddingTop: '100px' }}>
        <div style={{ textAlign: 'center', maxWidth: '480px' }}>
          ...
          <p style={{ color: '#464652', lineHeight: 1.7, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
            Tim AzeraKOL akan review pendaftaranmu. Kalau lolos, kamu akan dihubungi via WhatsApp beserta akses Talent Portal.
          </p>
        </div>
      </div>
    );
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '48px 24px 80px', position: 'relative', zIndex: 1 }}>
        ...
        {campaign.briefContent && (
          <div style={{ background: 'white', borderRadius: '16px', padding: '24px', marginBottom: '24px', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
            <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", color: '#464652', lineHeight: 1.7, whiteSpace: 'pre-wrap', fontSize: '0.9rem' }}>{campaign.briefContent}</p>
          </div>
        )}
